/*
  Board configuration file for X1501 Nano SoM EVB
...
#define CONFIG_KERNEL_ARGS "console=ttyS2,115200n8 mem=8M@0x0 loglevel=7 ingenic_pm_clk=0 devtmpfs.mount=1 init=/linuxrc rootfstype=squashfs root=/dev/mtdblock2 ro"
